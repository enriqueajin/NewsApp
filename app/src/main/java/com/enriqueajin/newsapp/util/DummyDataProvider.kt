...
object DummyDataProvider {
    ...
    fun getAllNewsItems(): List<NewsItem> {
        return listOf(
            NewsItem(title = "Israel implements new strategy", publishedAt = "", urlToImage = "https://ichef.bbci.co.uk/news/1024/branded_news/dc7e/live/8f7f6800-1e60-11ef-80aa-699d54c46324.jpg"),
